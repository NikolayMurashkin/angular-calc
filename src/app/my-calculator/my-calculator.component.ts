...
export class MyCalculatorComponent {
  ...
  public calcOperationsBetweenGroups: CalcOperations[] = [];
  public result?: number;

  public addCalcGroup(): void {
    ...
    this.calcOperationsBetweenGroups.push(CalcOperations.plus);
  }
  public removeCalcGroup(index: number): void {
    ...
    this.calcGroups.forEach((group, i) => {
      if (i === 0) {
        ...
        result = this.calc(
          result,
          tempResult,
          this.calcOperationsBetweenGroups[i - 1]
        );
      }
      tempHistory.push(
        `(${
